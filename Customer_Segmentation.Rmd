...
```{r}
features <- df %>% 
  select(Age, Has_Partner, Is_Parent, Family_Size, Education, Income, Recency, campaign_participation, Total_Purchaase, MntWines, MntFruits, MntMeatProducts, MntFishProducts, MntSweetProducts, MntGoldProds)
```
...
```{r}
features$Education = factor(features$Education, levels = c("Undergraduate", "Graduate", "Postgraduate"))
```
